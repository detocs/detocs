...
const usePlayer1Substate = useSubstate<InfoState, PersonUpdate>(
...
const usePlayer2Substate = useSubstate<InfoState, PersonUpdate>(
...
const useScore1Substate = useSubstate<InfoState, number>(
...
const useScore2Substate = useSubstate<InfoState, number>(
...
const useComment1Substate = useSubstate<InfoState, string | undefined>(
...
const useComment2Substate = useSubstate<InfoState, string | undefined>(
...
const useInLosers1Substate = useSubstate<InfoState, boolean | undefined>(
...
const useInLosers2Substate = useSubstate<InfoState, boolean | undefined>(
...
const useCommentator1Substate = useSubstate<InfoState, PersonUpdate>(
...
const useCommentator2Substate = useSubstate<InfoState, PersonUpdate>(
...
const useMatchSubstate = useSubstate<InfoState, Match>(
  state => state.match,
  (state, value) => updateImmutable(
    state,
    { match: { $set: value } },
...
const useGameSubstate = useSubstate<InfoState, Game>(
  state => state.game,
  (state, value) => updateImmutable(
    state,
    { game: { $set: value } },
...
const useTournamentSubstate = useSubstate<InfoState, string>(
...
const useBreakMessagesSubstate = useSubstate<InfoState, string[]>(
